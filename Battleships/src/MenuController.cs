...
static class MenuController
{
	...
	private static bool HandleMenuInput(int menu, int level, int xOffset)
	{
		...
		if (SwinGame.MouseClicked(MouseButton.LeftButton)) {
			int i = 0;
			//Edited by SzeSan change _menuStructure(menu) to _menuStructure[menu]
	...
	/// Edited by SzeSan added GameController.StartGame/AddNewState/EndCurrentState
	...
	/// </summary>
	/// <param name="button">the button pressed</param>
	/// Edited by SzeSan added GameController.SetDifficulty/EndCurrentState
	...
	/// </summary>
	/// <param name="button">the button pressed</param>
	/// Edited by SzeSan added GameController.AddNewState/EndCurrentState
